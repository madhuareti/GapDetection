stp1_struct = stp1_pts_res;
stp2_struct = stp2_pts_res;
for itr1 = 1 : size(stp1_struct,2)
    cur_nn_num_struct = stp1_pts_res;
    for itr2 = 1 : size(cur_nn_num_struct,2)
        cur_nnn_ip_data_struct = cur_nn_num_struct;
...
for itr1 = 1 : size(stp2_struct,2)
    cur_nn_num_struct = stp2_pts_res;
    for itr2 = 1 : size(cur_nn_num_struct,2)
        cur_nnn_ip_data_struct = cur_nn_num_struct;
        if size(cur_nnn_ip_data_struct,2) ~= 0 
            dmg_pts = cur_nnn_ip_data_struct.damaged_points;
