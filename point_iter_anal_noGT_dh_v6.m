...
num_iter = 150; % number of iterations to be performed
...
save_str_init = strcat("results",slsh,"oriented_xyz_1106",slsh);
...
ip_sample_itr = 13 + 1; %this will be editted by the bash script
