...
dmg_data_str = strcat("damaged_points_comp_untrans",slsh);
data_str1 = strcat("mat_xyz",slsh); % data path inside upper level
save_str0 = strcat("sample_data_complete_1007",slsh);
save_str00 = strcat("raw_data_complete",slsh);
save_str000 = strcat("damaged_points_complete",slsh);
...
tol_mult = [0,0.2]; %0.1 is observed from intial set of experiments
%% Read data files
...
end % end of looping over all the input datasets
